<div class="modal-body">
    <div class="form-group">
        ...
        <input type="text" id="adlib_url" name="adlib_url" value="{{ m.config.mod_zzc_adlib.url.value|escape }}" class="form-control do_autofocus" />
        {% wire id="adlib_url" type="change" action={config_toggle module="mod_zzc_adlib" key="url" on="keyup"} action={update target="adlib_databases" template="admin/adlib_databases.tpl"} %}
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            {% with m.config.mod_zzc_adlib.poll_frequency.value|if_undefined:"86400" as value %}
            ...
            {% wire id="poll_frequency" type="blur" action={config_toggle module="mod_zzc_adlib" key="poll_frequency" on="keyup"} %}
        </div>
    </div>
</div>
