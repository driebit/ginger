...
%% @doc A simplistic test: for return true when (at least) one rule already
%%      exists for the user group.
...
is_enabled(Context) ->
    ...
    lists:member(mod_content_groups, Modules) and lists:member(mod_content_groups, Modules).
