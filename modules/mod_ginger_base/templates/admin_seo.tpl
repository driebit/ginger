                        ...
                        <div class="form-group row">
                            <div class="col-md-8 col-md-offset-4">
                                <label class="checkbox-inline" for="seo-noindex" title="{_ Add a noindex, nofollow element to all pages. _}">
                                    <input type="checkbox" id="seo-noindex" name="seo-noindex" value="1" {% if m.config.seo.noindex.value %}checked="checked"{% endif %} disabled />
                                    {_ Exclude this site from search engines _}. {_ This setting can only be changed in the site config file. _}
                                </label>
                            </div>
                        </div>
                    </div>
