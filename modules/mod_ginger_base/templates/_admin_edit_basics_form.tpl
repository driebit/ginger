...
<fieldset class="form-horizontal">
    ...
    <div class="form-group row">
        <label class="control-label col-md-3" for="{{ #subtitle }}{{ lang_code_for_id }}">{_ Subtitle _} {{ lang_code_with_brackets }}</label>
        <div class="col-md-9">
            <input class="form-control" type="text" id="{{ #subtitle }}{{ lang_code_for_id }}" name="subtitle{{ lang_code_with_dollar }}" value="{{ is_i18n|if : r.translation[lang_code].subtitle : r.subtitle }}" {% if not is_editable %}disabled="disabled"{% endif %} {% include "_language_attrs.tpl" language=lang_code %} />
        </div>
    </div>
