...
%}
    ...
    {% if type == "list" %}
        ...
        {% with m.search.paged[{ginger_search hassubjects=hassubjects hasobjects=hasobjects hascustompivots=custompivots cat_exclude=cat_exclude content_group=content_group text=search_text pagelen=pagelen  date_start_year=date_start_year date_start_before=date_start_before date_start_after=date_start_after is_findable=is_findable keyword=keyword cat=cat sort=sort content_group=content_group }] as result %}
