...
as
    ...
    options_template
%}
    <div class="search__filters__section is-open do_search_cmp_filter_terms"  data-property="{{ property }}" data-dynamic="{{ dynamic }}" data-size="{{ size }}" data-sort-by-count="{{ sort_by_count }}" data-update-event="{{ #search_filter_update}}">
