{# Override template to pass template-defined continuation action(s) to mod_authentication #}
...
{% if use_wire %}
    ...
    #}
    {% wire id="logon_form" type="submit" postback={logon action=action} delegate="mod_authentication" %}
{% endif %}
