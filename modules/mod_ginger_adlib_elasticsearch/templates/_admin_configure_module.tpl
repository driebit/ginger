<div class="modal-body">
    <div class="form-group">
        ...
        <input type="text" class="form-control do_autofocus" id="index" placeholder="{{ m.config.mod_ginger_adlib_elasticsearch.index.value|default:m.site.host }}_adlib" value="{{ m.config.mod_ginger_adlib_elasticsearch.index.value|escape }}">
