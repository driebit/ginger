function ginger_map(options) {
	...
	for (i = 0; i < locations.length; i++) {
		...
		google.maps.event.addListener(marker, 'click', (function(marker, i) {
			return function() {
				var content = '<a href="' + locations[i].url + '" style="text-decoration: none; color: #58595b; font-weight: normal;"><h4 class="item-title">' + locations[i].title + '<h4><p>' + locations[i].summary + '</p></a>';
