...
{% if has_cg %}
    {% if content_group.o.hasbanner %}
        ...
        <a href="#" class="content-group-nav__banner" style="background-image: url('{% image_url banner_dep mediaclass='content-group-banner' %}');">
        ...
        <nav class="content-group-nav__menu">
             <ul>
                <li>
                    ...
                    "><i class=""></i>&nbsp; {% if content_group.short_title %}{{ content_group.short_title }}{% else %}{{ content_group.title }}{% endif %}</a></li>
