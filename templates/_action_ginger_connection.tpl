...
{% block widget_content %}
    ...
    {% with	m.rsc[cat_id].title|lower as cat_title %}
        <a id="{{ #connect.predicate }}" class="btn btn-small btn-add-story" href="#connect">+ {_ add my  _}  {% if title %} {{ title }} {% else %} {% if new_rsc_title %}{{ new_rsc_title }}{% else %}{{ cat_title|lower }}{% endif %}{% endif %} {_ to this  _}</a>
