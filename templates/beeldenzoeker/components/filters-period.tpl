<div class="search__filters__section--period {#do_search_cmp_filters_period #}">
    ...
    <div class="search__filters__section__inner">
	    <input type="number" name="filters_period_start" step="10" min="1000" max="{{ now|date:"Y" }}" placeholder="{_ Start year _}">
	    <input type="number" name="filters_period_end" step="10" min="1000" max="{{ now|date:"Y" }}" placeholder="{_ End year _}">
